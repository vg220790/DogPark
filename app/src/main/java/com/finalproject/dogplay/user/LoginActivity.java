...
//        playgroundArrayList.add(new Playground("עין הקורא 21, תל אביב יפו",32.057372,34.783016));
        ...
        playgroundArrayList.add(new Playground("הבית של ויקה: סירקין 22, תל אביב יפו", 32.078525, 34.770015));
        ...
        for(Playground playground : playgroundArrayList){
            DatabaseReference newPlayground = databasePlaygrounds.push();
            newPlayground.child("id").setValue(newPlayground.getKey());
            playground.setId(newPlayground.getKey());
            databasePlaygrounds.child(newPlayground.getKey()).setValue(playground);
            newPlayground.child("address").setValue(playground.getAddress());
            newPlayground.child("latitude").setValue(playground.getLatitude());
            newPlayground.child("longitude").setValue(playground.getLongitude());
